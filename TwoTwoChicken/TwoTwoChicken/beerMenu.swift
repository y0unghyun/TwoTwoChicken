...
class BeerMenu : MenuRef {
    ...
    func printMenu() {
        ...
        print("""
              ...
              *-----------------------------------------------------------------------*
              | 1. Philsner       |W 3.9| 뒷맛이 쌉쌀하면서 깔끔한 가벼운 체코식 맥주            |
              | 2. Weiss          |W 3.9| 진한 과일향과 부드러운 목넘김이 매력적인 밀맥주         |
              | 3. Dunkles        |W 3.9| 달콤하고 고소한 향이 어우러져 진한 풍미가 일품인 흑맥주   |
              | 4. Weissbockbier  |W 4.9| 깊이 있고 부드러운 과일향을 가진 고알콜맥주            |
